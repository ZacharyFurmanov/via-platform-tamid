...
function AuthErrorContent() {
 ...
 return (
 <main className="bg-[#FFFDF8] min-h-screen flex items-center justify-center px-6">
 ...
 <Link
 href="/login"
 className="inline-block bg-[#5D0F17] text-[#FFFDF8] py-3.5 px-8 text-sm uppercase tracking-wide hover:bg-[#5D0F17]/85 transition"
 >
 Try Again
 </Link>
 </div>
