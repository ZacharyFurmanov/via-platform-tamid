...
function SearchResultsContent({ q }: { q: string }) {
 ...
 <div className="flex flex-wrap gap-x-10 gap-y-6 mb-12 pb-10">
 ...
 className="text-xs uppercase tracking-wide border border-[#5D0F17]/20 px-3 py-1.5 bg-[#FFFDF8] text-[#5D0F17] outline-none hover:border-[#5D0F17] transition-colors cursor-pointer ml-auto"
 >
