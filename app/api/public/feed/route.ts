...
/**
 * Public product feed for the mobile app.
 * Returns recent products without requiring login.
 * Mirrors the same visibility rules as the web (Shopify needs collabs_link).
 */
