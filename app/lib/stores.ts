export const stores = [
  ...
  },
  {
    ...
    location: "",
    description:
      "Nello Vintage is a curated vintage shop offering one-of-a-kind pieces sourced with a careful eye for quality and style.",
...
export const storeContactEmails: Record<string, string> = {
  ...
  "the-vntg-collective": "thevntgcollective@gmail.com",
