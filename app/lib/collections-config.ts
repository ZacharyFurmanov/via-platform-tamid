export const COLLECTIONS = [
  ...
  { slug: "y2k-girls", name: "Y2K Girls", curatedBy: "Y2K Girls", href: null, description: "Pure 2000s energy — baby tees, low-rise, logomania, and the it-bags of the era. For the girls who do it Y2K." },
] as const;
