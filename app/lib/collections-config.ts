export const COLLECTIONS = [
  ...
  { slug: "mothers-day", name: "Mother's Day", curatedBy: "Lisa Teich", href: null, description: "Every cool Mom needs these for her lifestyle. Whether it's running w babies and needing a chic baby bag, going out to dinner w grown kids needing a chic ballet flat & shoulder bag or chic Glam-Mas. These accessories will fit \"all the things\" for all the Moms out there!" },
] as const;
