...
// serve WebP via content negotiation, which 500s the OG image. Fetch the image
// ourselves forcing a non-WebP format and inline it as a data URI so the
// preview always renders; fall back to the placeholder if it isn't JPEG/PNG.
...
export default async function Image({ params }: { params: Promise<{ id: string }> }) {
 ...
 imageUrl = product.image ? await fetchAsDataUri(product.image) : null;
 }
 } catch {}
 }
 }
