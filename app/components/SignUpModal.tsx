...
export default function SignUpModal({ isOpen, onClose, callbackUrl, required = false }: SignUpModalProps) {
 ...
 {/* Modal */}
 <div
 className={`relative w-full max-w-sm mx-4 bg-[#FFFDF8] shadow-2xl transition-all duration-300 ease-out ${
 ...
 className="w-full flex items-center justify-center gap-3 bg-[#5D0F17] text-[#FFFDF8] py-3.5 text-sm uppercase tracking-wide hover:bg-[#5D0F17]/85 transition mb-3"
 >
 ...
 type="submit"
 disabled={loading}
 className="w-full bg-[#5D0F17] text-[#FFFDF8] py-3.5 text-sm uppercase tracking-wide hover:bg-[#5D0F17]/85 transition disabled:opacity-50"
 >
