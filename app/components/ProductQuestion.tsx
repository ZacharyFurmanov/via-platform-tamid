...
export default function ProductQuestion({
 ...
 className="bg-[#5D0F17] text-[#FFFDF8] text-[11px] uppercase tracking-[0.15em] px-6 py-3 hover:bg-[#5D0F17]/85 transition disabled:opacity-50 disabled:cursor-not-allowed"
 >
