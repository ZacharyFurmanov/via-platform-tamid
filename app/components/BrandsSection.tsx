...
export default async function BrandsSection() {
 ...
 >
 <h3 className="font-serif text-sm sm:text-xl text-[#5D0F17] group-hover:text-[#FFFDF8] transition-colors duration-300 leading-snug">
 {brand.label}
 </h3>
 <p className="text-xs text-[#5D0F17]/50 group-hover:text-[#FFFDF8]/70 mt-1.5 transition-colors duration-300">
